...
const translations = {
    en: {
        ...
        about_p1: "Ha Long Import-Export and Manufacturing Joint Stock Company is a prestigious entity specializing in production and international trade connectivity. We provide high-quality frozen food products under strict inspection standards, including chicken paws, chicken wings, beef, and omasum (beef tripe),... along with other key agricultural commodities.",
        about_p2: "We are committed to delivering optimal and stable supply chain solutions for both domestic and global markets.",
    ...
    vi: {
        ...
        about_p1: "Công ty Cổ phần Sản xuất và Xuất nhập khẩu Hạ Long là đơn vị uy tín trong lĩnh vực sản xuất và kết nối giao thương quốc tế. chúng tôi chuyên cung cấp nguồn thực phẩm đông lạnh chất lượng cao, tiêu chuẩn kiểm duyệt khắt khe như: chân gà, cánh gà, thịt bò, dạ sách... cùng nhiều mặt hàng nông sản chủ lực khác.",
        about_p2: "Chúng tôi cam kết mang đến giải pháp cung ứng tối ưu, ổn định cho thị trường trong nước và toàn cầu.",
    ...
    zh: {
        ...
        btn_contact: "立即联系",
        about_title: "公司简介",
        about_p1: "下龙生产与进出口股份公司是国际生产与贸易衔接领域的资深信誉单位。我们专业提供经过严格检验的高质量冷冻食品，如：**鸡爪、鸡翅、牛肉、牛百叶（牛草肚）**以及多种核心农产品",
        about_p2: "下龙致力于为国内外市场提供优化且稳定的供应链解决方案。",
        contact_title: "联系我们",
        form_name: "姓名",
        form_email: "电子邮件",
        form_msg: "咨询内容",
